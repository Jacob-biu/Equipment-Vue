  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="告警类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择告警类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="warnList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备位置" align="center" prop="equipmentPostion" />
      <el-table-column label="告警类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.warn_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="设备ID" prop="equipmentId">
          <el-input v-model="form.equipmentId" placeholder="请输入设备ID" :disabled="true"/>
        </el-form-item>
        <el-form-item label="设备名称" prop="equipmentName">
          <el-input v-model="form.equipmentName" placeholder="请输入设备名称" :disabled="true"/>
        </el-form-item>
        <el-form-item label="设备位置" prop="equipmentPostion">
          <el-input v-model="form.equipmentPostion" placeholder="请输入设备位置" :disabled="true"/>
        </el-form-item>
        <el-form-item label="告警类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择告警类型" :disabled="true">
            <el-option
              v-for="dict in dict.type.warn_type"
              :key="dict.value"
              :label="dict.label"
